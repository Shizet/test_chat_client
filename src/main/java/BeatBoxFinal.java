package main.java;//import MyUpTempoListener.MySendListener.RemoteReader;
//import MyUpTempoListener.MySendListener.RemoteReader;
//import BeatBoxFinal.MyUpTempoListener.MySendListener.RemoteReader;
import java.awt.*;
import javax.swing.*;
import java.io.*;
...
public class BeatBoxFinal {
    ...
    public static void main (String[] args){
        new BeatBoxFinal().startup("123");// это ваш пользовательский
